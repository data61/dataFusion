...
/**
 * Copied/modified from stanford-corenlp-3.8.0.
 * 
...
public class NumberNormalizer {
  ...
  private static final Pattern bigNumNoSpacePattern = Pattern.compile("(\\d)(hundred|thousand|billion|trillion)");
  ...
  public static Number wordToNumber(String str) {
    ...
    // Data61: add a space between digit and hundred|thousand|billion|trillion
    Matcher mbig = bigNumNoSpacePattern.matcher(str);
    str = mbig.replaceAll("$1 $2");
