...
//
// The junrar and jcip-annotations dependencies of tika-parsers have dubious licenses, so these are excluded.
// An alternative jcip-annotations is used (no alternative for unrar)
  

libraryDependencies ++= Seq(
  "org.apache.tika" % "tika-parsers" % "1.16" exclude("edu.ucar", "jj2000") exclude("edu.usc.ir", "sentiment-analysis-parser") exclude("com.github.junrar", "junrar") exclude("net.jcip", "jcip-annotations"),
